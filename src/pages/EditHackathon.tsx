...
export default function EditHackathon() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!id) throw new Error('Hackathon ID not found');
      ...
      // If admin, redirect to admin hackathons page; otherwise go to hackathon details
      if (isAdmin) {
      ...
      <div className="container mx-auto px-4 py-6 md:py-8">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="mb-6 md:mb-8">
            ...
            <p className="text-center text-sm md:text-base text-muted-foreground">Edit hackathon details</p>
            <p className="text-center text-xs text-muted-foreground mt-2">Developed by HackMates Team</p>
          </div>
          ...
          <div className="bg-card border border-border rounded-lg shadow-lg p-4 md:p-8">
            <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
              ...
              <Button
                ...
                size="lg"
              >
                {isSubmitting ? 'Updating Hackathon...' : 'Update Hackathon'}
              </Button>
            </form>
          </div>
        </div>
